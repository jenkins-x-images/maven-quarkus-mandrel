...
export APP_NAME='maven-quarkus-mandrel'
...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-images/maven-quarkus-mandrel/main/1'
...
export MINK_IMAGE='ghcr.io/jenkins-x/maven-quarkus-mandrel:0.0.2'
export NAMESPACE_SUB_DOMAIN='-jx.'
export PIPELINE_KIND='release'
export PUSH_CONTAINER_REGISTRY='ghcr.io'
export REPO_NAME='maven-quarkus-mandrel'
export REPO_OWNER='jenkins-x-images'
